...
```{r fit stan}
fit <- sampling(model_1,data = data_stan, algorithm='NUTS',iter = 1000, init = init.f,chains = 1,refresh=100,pars=c('amp','latency','tau1','tau2','scr_sigma'),control=list(adapt_delta=0.5))
