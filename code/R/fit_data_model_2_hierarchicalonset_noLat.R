...
if (1==0){
  ...
  t = '1:4'
  #t = '1'
  cmd=paste0('qsub -cwd -t ',t, ' -o ', cfg$gridOutputPath, '/ -e ', cfg$gridOutputPath, '/ -l ', cfg$requirements, ' -N ', cfg$job_name, ' -pe default ', 1, ' -q nbp.q fit_data_model_2_hierarchicalonset_noLat.R')
  system(cmd)
}
...
name = '2015-12-01_scr_model_2_hierarchicalonset_noLat'
